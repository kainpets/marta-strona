...
function OMnie() {
  return (
    <main className="max-w-screen-2xl m-auto pt-4">
      <div className="flex flex-col gap-4 sm:flex-row pt-16 leading-relaxed md:leading-normal" style={{ maxHeight: "70vh" }}>
        <Image src={martaKciuki} placeholder="blur" style={{ height: "auto", maxHeight: "100%"}} className="rounded object-scale-down max-w-full sm:max-w-lg" alt="Uśmiechnięta Marta z dwoma kciukami w górze" />
